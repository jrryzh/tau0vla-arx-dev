...
_REPO = os.environ.get(
    "ARX_0905_ZYP_GYT_FIRST50_LEROBOT_ROOT",
    str(
        Path(__file__).resolve().parents[2]
        / "data/0905_training/0905-zyp-gyt-first50/lerobot_v3_30fps_state_t_plus_1"
    ),
)
...
@register_config
def arx_lift2s_0905_zyp_gyt_first50_ft() -> ArxLift2sUnified:
