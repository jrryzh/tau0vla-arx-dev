...
_REPO = os.environ.get(
    "ARX_0905_DATASETS_LAST50_LEROBOT_ROOT",
    str(
        Path(__file__).resolve().parents[2]
        / "data/0905_training/0905-datasets-last50/lerobot_v3_30fps_state_t_plus_1"
    ),
)
...
@register_config
def arx_lift2s_0905_datasets_last50_ft() -> ArxLift2sUnified:
